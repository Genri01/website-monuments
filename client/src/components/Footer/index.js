      ...
      <div className="footer_container">
        <div className="footer_up">
          <div className="footer_logo_section">
            <iframe src="https://yandex.ru/map-widget/v1/-/CKaAJA14" width="460" height="240" frameborder="1" allowfullscreen="true"></iframe> 
          </div>
          <div className="footer_desription_section_left">
          <Link to={"/"}><div className="footer_txt" >Каталог</div></Link>
          <Link to={"/"}><div className="footer_txt" >Наши работы</div></Link>
          <Link to={"/"}><div className="footer_txt" >Отзывы</div></Link>
          </div>
          <div className="footer_desription_section_right">
            <Link to={"/"}><div className="footer_txt">Вопросы и ответы</div></Link>
            <Link to={"/"}><div className="footer_txt">О нас</div></Link>
        ...
        <div className="footer_down">
          <div className="coperait_container">
            <div className="coperait_txt">Copyright © 2022 Лучшие памятники АНАПЫ!</div>
          </div>
